...
__webpack_require__(/*! ./app.global.less */ "./src/app.global.less");
...
var requestUrl = 'https://cgf.scyuronghe.com'; //https://wap.scttlg.com  http://47.107.65.90:8080  192.168.2.168:9001
...
module.exports = {
  ...
  setToken: function setToken(token) {
    try {
      return _taroWeapp2.default.setStorageSync('token', token);
    } catch (e) {}
    return null;
  },
  getUnionuser: function getUnionuser() {
    try {
      return _taroWeapp2.default.getStorageSync('unionuser');
    } catch (e) {}
    return null;
  },
  setUnionuser: function setUnionuser(unionuser) {
    try {
      return _taroWeapp2.default.setStorageSync('unionuser', unionuser);
    } catch (e) {}
    return null;
  }
};
...
exports.default = {
  ...
  effects: {
    error: /*#__PURE__*/_regenerator2.default.mark(function error(_ref2, _ref3) {
      var e = _ref2.payload;
      var all = _ref3.all,
          call = _ref3.call,
          put = _ref3.put;
      return _regenerator2.default.wrap(function error$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              // debugger;
...
var _home = __webpack_require__(/*! ../services/home */ "./src/services/home.js");
...
exports.default = {
  ...
  effects: {
    query: /*#__PURE__*/_regenerator2.default.mark(function query(_ref, _ref2) {
      var payload = _ref.payload,
      ...
      return _regenerator2.default.wrap(function query$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _taroWeapp2.default.showLoading({ title: '加载中...', mask: true });
            ...
            case 9:
              ...
              _context.next = 12;
              return _taroWeapp2.default.setStorageSync('shopInfo', response.data.shopVO);
    ...
    service: /*#__PURE__*/_regenerator2.default.mark(function service(_ref3, _ref4) {
      ...
      return _regenerator2.default.wrap(function service$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
...
var _global = __webpack_require__(/*! ./global */ "./src/model/global.js");

var _global2 = _interopRequireDefault(_global);

var _home = __webpack_require__(/*! ./home */ "./src/model/home.js");

var _home2 = _interopRequireDefault(_home);

var _mine = __webpack_require__(/*! ./mine/mine */ "./src/model/mine/mine.js");

var _mine2 = _interopRequireDefault(_mine);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = [_global2.default, _home2.default, _mine2.default];

/***/ }),

/***/ "./src/model/mine/mine.js":
/*!********************************!*\
  !*** ./src/model/mine/mine.js ***!
  \********************************/
/*! no static exports found */
...
var _mine = __webpack_require__(/*! ../../services/mine */ "./src/services/mine.js");
...
var queryHome = exports.queryHome = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(params, data) {
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
exports.feedback = exports.getPhoneNumber = exports.login = undefined;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(params, data) {
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', (0, _request2.default)({ url: '/userApi/login', params: params, data: data, method: 'POST' }));
...
var getPhoneNumber = exports.getPhoneNumber = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(params) {
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', (0, _request2.default)({ url: '/weiXinApi/getWechatPhone', params: params }));
  ...
  return function getPhoneNumber(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
//意见反馈
...
var feedback = exports.feedback = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(params, data) {
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt('return', (0, _request2.default)({ url: '/auth/feedbackApi/saveFeedback', params: params, data: data, method: 'POST' }));
  ...
  return function feedback(_x4, _x5) {
...
_taroWeapp2.default.addInterceptor(_taroWeapp2.default.interceptors.timeoutInterceptor); //内置请求超时时抛出错误。
