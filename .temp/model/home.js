import Taro, { showLoading as _showLoading, setStorageSync as _setStorageSync, hideLoading as _hideLoading } from "@tarojs/taro-h5";
...
export default {
  ...
  effects: {
    *query({ payload, onSuccess }, { select, call, put }) {
      yield _showLoading({ title: '加载中...', mask: true });
      ...
      if (response) {
        ...
        yield _setStorageSync('shopInfo', response.data.shopVO);
        yield _hideLoading();
      }
    },
