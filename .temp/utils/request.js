import Taro, { addInterceptor as _addInterceptor, request as _request, showModal as _showModal, clearStorageSync as _clearStorageSync, hideLoading as _hideLoading, hideToast as _hideToast } from "@tarojs/taro-h5";
...
_addInterceptor(Taro.interceptors.timeoutInterceptor); //内置请求超时时抛出错误。

export default function request({ url, params, data, method, success, complete }) {
  if (url.substr(0, 4) != 'http') url = rootUrl + url;
